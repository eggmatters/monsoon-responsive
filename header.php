    ...
    <?php $mcsc = get_mr_theme_root_uri() . '/images/monsoon-logo-pos.png'; ?>
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo site_url(); ?>" title="Monsoon Commerce Support Center"><img src="<?php echo $mcsc; ?>" style="max-width:110px; margin-top: -9px;"><span style="color: black; margin-left: -1%; font-size: 77%">SUPPORT CENTER</span></a>
        </div>
